...
''' Django settings for SmartManagement project.
...
INSTALLED_APPS = [
    ...
    'API', 'rest_framework', 'rest_framework_api_key', 'corsheaders'
]
...
ROOT_URLCONF = 'SmartManagement.urls'
...
WSGI_APPLICATION = 'SmartManagement.wsgi.application'
